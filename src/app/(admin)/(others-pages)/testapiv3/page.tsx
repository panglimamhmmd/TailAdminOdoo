              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                ...
                <div className="text-sm text-blue-800 space-y-1">
                  ...
                  <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                    ...
                    <li><code className="bg-blue-100 px-2 py-1 rounded">price_unit</code> - Harga satuan (angka atau format Rp)</li>
                      ...
                      {(showAllLines ? parsedData.lines : parsedData.lines.slice(0, 10)).map((line, idx) => {
                        ...
                        return (
                          <tr key={idx} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 text-sm text-gray-900 font-medium">{line.so_number}</td>
                ...
                {parsedData.lines.length > 10 && (
                  <div className="bg-gray-50 px-4 py-3 border-t border-gray-200">
                    <button
                      ...
                      className="w-full py-2 px-4 bg-blue-100 hover:bg-blue-200 text-blue-700 font-medium rounded-lg transition-colors"
                    >
                      {showAllLines ? (
                        <>👆 Show Less (Collapse)</>
                      ) : (
            ...
            <div className="space-y-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold text-green-800">Success!</h3>
                ...
                {response.results.map((result: ResponseResult, idx: number) => (
                  <div key={idx} className="border border-gray-200 rounded-lg p-6 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-semibold text-gray-800">SO: {result.so_number}</h3>
                      ...
                      {result.lines.map((line: ResponseLine, lineIdx: number) => (
                        <div 
                          ...
                          className={`p-4 rounded-lg ${
                            line.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'
                          }`}
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              {line.success ? (
                                ...
                                <p className="text-sm text-red-600 mt-2">Error: {line.error}</p>
                              )}
                            </div>
                          </div>
                        </div>
