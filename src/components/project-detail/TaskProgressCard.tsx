...
export const TaskProgressCard: React.FC<TaskProgressCardProps> = ({ currentSubProject }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 rounded-2xl p-4 md:p-6 border border-orange-200 dark:border-orange-900/50">
